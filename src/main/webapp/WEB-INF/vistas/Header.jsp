...
<div class="wrapper">
	...
	<nav id="sidebar">
		...
		<ul class="list-unstyled components" style="height: 55vh;">
			<li class="active">
...
">
				...
				<ul class="list-unstyled CTAs">
					<li>
						<c:if test="${requestScope.objUsuario.idUsuario != 0 }">
							<a href="/Acceso/Close" class="article">Close</a>
						</c:if>
						<c:if test="${requestScope.objUsuario == 0 }">
							<a href="/Acceso/Login" class="article">Login</a>
						</c:if>
					</ul>
				</nav>
				<!-- Page Content Holder -->
...
<input class="form-control text-box single-line" id="correo" name="Login" placeholder="Usuario" type="text" value="">        <br>
