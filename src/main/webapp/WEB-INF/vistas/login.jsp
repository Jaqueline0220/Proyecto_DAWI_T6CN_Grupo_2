...
<body style="background-color: white !important;padding: 0px !important ">  
...
">
						...
						<div style="background-color:white;border:1px solid #fafafa" class="jumbotron boxlogin">

<form  action="login" class="form-signin" method="post" name="flogin" role="form">   
        ...
        <div class="col-sm-12">
              <span>
				<c:if test="${requestScope.MENSAJES != null }">
				    ...
				    <c:remove var="MENSAJES" scope="session"/></span>
        </div>
      </div>     
<input class="form-control text-box single-line" id="correo" name="correo" placeholder="Usuario" type="text" value="">        <br>
<input class="form-control text-box single-line" id="Clave" name="password" placeholder="Password" type="password" value="">        <br>
        <input id="" style="color:white;background: red;" class="btn btn-danger form-control" type="submit" value="Login">
</form></div>
				</div>
