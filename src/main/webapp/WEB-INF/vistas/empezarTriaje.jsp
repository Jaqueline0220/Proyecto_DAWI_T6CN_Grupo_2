   ...
   <body style="background-color: white !important">
      <div class="wrapper">
         ...
         <div id="content" class="container">
            ...
            <!-- CODIGO DE REGISTRO DE TRIAJE -->
            <div class="row">
               <div class="col-md-8 col-md-offset-2">
                    <form action="empezarTriaje" method="post">
                     <h1  class="">Antes de empezar, verifica que no sea una emergencia</h1>
                     <p class="font-bold" id="emergency-desc">Llama al 106 (SAMU) o al 117 (Essalud) si tienes alguno de estos síntomas:</p>
                     <ul class="list-disc ">
                        <li class="list-disc">Sensación de falta de aire o dificultad para respirar en reposo.</li>
                        <li class="list-disc">Desorientación o confusión.</li>
                        <li class="list-disc">Fiebre mayor a 38°C persistente por más de dos días.</li>
                        <li class="list-disc">Dolor en el pecho.</li>
                        <li class="list-disc">Coloración azul en los labios, manos o pies (cianosis).</li>
                     </ul>
                     <fieldset class="">
                        <label class=" checkbox-inline checkbox-info">
                        <input id="Checkbox" type="checkbox" value="">Realizar prueba de descarto de Covid19
                        </label>
                     </fieldset>
                     <button id="Continuar" class="btn btn-primary" type="submit" disabled="disabled" >Continuar</button>
                  </form>
               </div>
            </div>
